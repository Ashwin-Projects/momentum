      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 border-r border-white/[0.04]">
        ...
        <div className="space-y-4">
          <p className="text-3xl font-semibold text-white leading-snug tracking-tight">
            Every great day<br />starts with clarity.
          </p>
          <p className="text-sm text-zinc-500 leading-relaxed max-w-xs">
            Track study, fitness, nutrition, and sleep — all in one place. Built for people serious about performance.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-500">Welcome back. Enter your credentials.</p>
          </div>
          ...
          <p className="text-sm text-zinc-500 text-center">
            ...
            <Link to="/register" className="text-[#d97706] hover:text-[#fbbf24] transition-colors">
              Create one
            </Link>
          </p>
        </div>
